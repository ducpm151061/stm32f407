...
{	  
	...
	LCD_ShowNum(40+24,140,x0,4,16,0);		//显示数值
	LCD_ShowNum(40+24+80,140,y0,4,16,0);	//显示数值
	LCD_ShowNum(40+24,160,x1,4,16,0);		//显示数值
	LCD_ShowNum(40+24+80,160,y1,4,16,0);	//显示数值
	LCD_ShowNum(40+24,180,x2,4,16,0);		//显示数值
	LCD_ShowNum(40+24+80,180,y2,4,16,0);	//显示数值
	LCD_ShowNum(40+24,200,x3,4,16,0);		//显示数值
	LCD_ShowNum(40+24+80,200,y3,4,16,0);	//显示数值
 	LCD_ShowNum(40+56,220,fac,3,16,0); 	//显示数值,该数值必须在95~105范围之内.
}
