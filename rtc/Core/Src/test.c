...
/*****************************************************************************
 * @name       :void RTC_test(void)
 * @date       :2018-08-09 
 * @function   :show RTC test
 * @parameters :None
 * @retvalue   :None
******************************************************************************/
void RTC_test(void)
...
/*****************************************************************************
 * @name       :void RTC_Show_time(void)
 * @date       :2018-08-09 
 * @function   :show rtc time
 * @parameters :None
 * @retvalue   :None
******************************************************************************/
void RTC_Show_time(void)
{
	...
	sprintf((char *)rtc_buf, "Time:%02d:%02d:%02d", RTC_TimeStruct.RTC_Hours, RTC_TimeStruct.RTC_Minutes, RTC_TimeStruct.RTC_Seconds);
	Show_Str(lcddev.width / 2 - 52, 140, RED, WHITE, rtc_buf, 16, 0);

	RTC_GetDate(RTC_Format_BIN, &RTC_DateStruct);
	sprintf((char *)rtc_buf, "Date:20%02d-%02d-%02d", RTC_DateStruct.RTC_Year, RTC_DateStruct.RTC_Month, RTC_DateStruct.RTC_Date);
	Show_Str(lcddev.width / 2 - 52, 160, RED, WHITE, rtc_buf, 16, 0);
	sprintf((char *)rtc_buf, "Week:%d", RTC_DateStruct.RTC_WeekDay);
	LCD_ShowString(lcddev.width / 2 - 52, 180, 16, rtc_buf, 1);
}

/*****************************************************************************
 * @name       :void RTC_Show_AlarmA_time(void)
 * @date       :2018-08-09 
 * @function   :show rtc alarmA time
 * @parameters :None
 * @retvalue   :None
******************************************************************************/
void RTC_Show_AlarmA_time(void)
{
	u8 rtc_alarm_buf[40];
	RTC_AlarmTypeDef RTC_AlarmTypeInitStructure;
	RTC_GetAlarm(RTC_Format_BIN, RTC_Alarm_A, &RTC_AlarmTypeInitStructure);
	sprintf((char *)rtc_alarm_buf, "Alarm Time:%02d:%02d:%02d  Week:%d", RTC_AlarmTypeInitStructure.RTC_AlarmTime.RTC_Hours,
