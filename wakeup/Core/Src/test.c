...
void wakeup_test(void)
{
	printf("wake up test\r\n");
	Gui_StrCenter(0,40,RED,BLUE,"STM32F407VxT6最小系统开发板",16,1);//居中显示
	Gui_StrCenter(0,65,RED,BLUE,"WAKE UP 测试程序",16,1);//居中显示	
	Gui_StrCenter(0,90,RED,BLUE,"press KEY_UP 3s",16,1);//居中显示	
	Gui_StrCenter(0,115,RED,BLUE,"for stand by/wake up",16,1);//居中显示	
