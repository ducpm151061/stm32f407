...
void ADC_test(void)
{
	USART1_printf(USART1,"adc test\r\n");
	printf("adc test\r\n");
	Gui_StrCenter(0,40,RED,BLUE,"STM32F407VxT6��Сϵͳ������",16,1);//������ʾ
	Gui_StrCenter(0,65,RED,BLUE,"ADC ���Գ���",16,1);//������ʾ	
	Show_Str(lcddev.width/2-68,90,BLUE,BLUE,"ADC1_CH5_VAL:",16,1);//������ʾ	
	Show_Str(lcddev.width/2-68,115,BLUE,BLUE,"ADC1_CH5_VOL:",16,1);//������ʾ
	Show_Str(lcddev.width/2+36,115,RED,BLUE,"0.000V",16,1);//������ʾ
...
void Show_ADC_Value(void)
{
	...
	float temp;
	char send[50];
	adcx=Get_ADC_Average_Value(ADC_Channel_5,20);//��ȡͨ��5��ת��ֵ��20��ȡƽ��
	LCD_ShowNum(lcddev.width/2+36,90,adcx,4,16,0);    //��ʾADCC�������ԭʼֵ
	sprintf(send,"adcx: %lu\r\n",adcx);
	USART1_printf(USART1,send);

	temp=(float)adcx*(3.3/4096);          //��ȡ�����Ĵ�С����ʵ�ʵ�ѹֵ������3.1111
	adcx=temp;                            //��ֵ�������ָ�adcx��������ΪadcxΪu16����
	LCD_ShowNum(lcddev.width/2+36,115,adcx,1,16,0);    //��ʾ��ѹֵ���������֣�3.1111�Ļ������������ʾ3
	sprintf(send,"adcx convert voltage: %lu\r\n",adcx);
	USART1_printf(USART1,send);

	temp-=adcx;                           //���Ѿ���ʾ����������ȥ��������С�����֣�����3.1111-3=0.1111
	temp*=1000;                           //С�����ֳ���1000�����磺0.1111��ת��Ϊ111.1���൱�ڱ�����λС����
	LCD_ShowNum(lcddev.width/2+52,115,temp,3,16,1); //��ʾС�����֣�ǰ��ת��Ϊ��������ʾ����������ʾ�ľ���111.
	sprintf(send,"adcx temp: %.3f\r\n",temp);
	USART1_printf(USART1,send);
