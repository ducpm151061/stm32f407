...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
    {
        ...
        {IMAGE_CreateIndirect, "IconBack", ID_IMAGE_1, 54, 410, 42, 42, 0, 0x00200020, 0},
        {IMAGE_CreateIndirect, "IconNext", ID_IMAGE_2, 223, 410, 42, 42, 0, 0x00200020, 0},
...
static void _cbDialog(WM_MESSAGE *pMsg)
{
    ...
    case WM_INIT_DIALOG:
        ...
        TEXT_SetText(TxtHeader, Txt_THOICHUDONG);
        ...
        TEXT_SetFont(TxtKQValue, &GUI_FontArial96_B_Lite);
        ...
        char Buff[20];
        sprintf(Buff, "%.2f", xSystem.Record.Name.KetQua.value);
        if (xSystem.Record.Name.KetQua.value > 0.05)
        {
            TEXT_SetTextColor(TxtKQValue, GUI_RED);
        ...
        {
            TEXT_SetTextColor(TxtKQValue, GUI_MAKE_COLOR(0x00389710));
            TEXT_SetText(TxtKQValue, (const char *)Buff);
        }
        ...
        if (xSystem.Record.Name.KetQua.value > 0.05)
        {
            ...
            TEXT_SetText(TxtKQString, Txt_KetQuaStringCo);
        }
        else
        {
            TEXT_SetTextColor(TxtKQString, GUI_MAKE_COLOR(0x00389710));
            TEXT_SetText(TxtKQString, Txt_KetQuaStringKoCo);
        }
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_IMAGE_0: // Notifications sent by 'IconHome'
            ...
            break;
        case ID_IMAGE_1: // Notifications sent by 'IconBack'
            switch (NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                // USER START (Optionally insert code for reacting on notification message)
            ...
            break;
        case ID_IMAGE_2: // Notifications sent by 'IconNext'
            switch (NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                // USER START (Optionally insert code for reacting on notification message)
            ...
            case WM_NOTIFICATION_RELEASED:
                // USER START (Optionally insert code for reacting on notification message)
                BTP_Next();
                xSystem.Keypad.WD_Req = WD_KQDCD;
                // USER END
                break;
            case WM_NOTIFICATION_MOVED_OUT:
                // USER START (Optionally insert code for reacting on notification message)
