...
#define ID_TEXT_2 (ID_WPAGE_1 + 0x05)
#define ID_SLIDER_2 (ID_WPAGE_1 + 0x06)
#define ID_TEXT_3 (ID_WPAGE_1 + 0x07)
#define ID_SLIDER_3 (ID_WPAGE_1 + 0x08)
...
//#define ID_BUTTON_35          (ID_WPAGE_2 + 0x28)

//#define ID_SCROLLBAR_1 (ID_WPAGE_2 + 0x24)

#define ID_WPAGE_3 (GUI_ID_USER + 0x50)
#define ID_EDIT_43 (ID_WPAGE_3 + 0x01)
#define ID_BUTTON_31 (ID_WPAGE_3 + 0x02)
#define ID_BUTTON_32 (ID_WPAGE_3 + 0x03)
#define ID_BUTTON_33 (ID_WPAGE_3 + 0x04)
#define ID_BUTTON_34 (ID_WPAGE_3 + 0x05)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
    {
        ...
        {MULTIPAGE_CreateIndirect, "MultiPage", ID_MULTIPAGE_0, 0, 0, 320, 405, 0, 0x0, 0},
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Page1[] =
    {
        ...
        {WINDOW_CreateIndirect, "Page 1", ID_WPAGE_1, 0, 0, 320, 440, FRAMEWIN_CF_MOVEABLE},
...
static void _cbDialog_Page1(WM_MESSAGE *pMsg)
{
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_SLIDER_3: // Notifications sent by 'Slider'
            ...
            case WM_NOTIFICATION_VALUE_CHANGED:
                hItem = WM_GetDialogItem(pMsg->hWin, ID_SLIDER_3);
                //xSystem.Parameters.TimeoutKeypad = SLIDER_GetValue(hItem);
                break;
            }
            break;
        }
...
void MTAB_CLIB_Update_Fr_Keypad(void)
{
    /*WM_HWIN hItem;
    Al_CalibTable_t *AlMCalibData = &xSystem.Parameters.AlMCalibData;
    if (xSystem.Keypad.Status == KP_ENTER)
    {
        if (xSystem.Keypad.Type_Req == KP_REQ_PASS)
        {
            ...
            {
                MultiPage_SetPage(SelectedTabIndex);
                isLogined = 1;
            }
            else
                MultiPage_SetPage(0);
            ...
            case ID_EDIT_43:
                xSystem.Record.Name.IndexStore = GetNumberFromString(0, (char *)xSystem.Keypad.Str);
                break;
            }
    }
    ...
    GUI_WD_Change(WD_MTAB_SETUP);*/
}

//=====================================================================

static const GUI_WIDGET_CREATE_INFO _aDialogCreate_Page3[] =
    {
        {WINDOW_CreateIndirect, "Page 3", ID_WPAGE_3, 0, 0, 320, 440, FRAMEWIN_CF_MOVEABLE},
        {EDIT_CreateIndirect, "ED_RecIndex", ID_EDIT_43, 30, 40, 100, 50, 0, 0x0, 0},
        {BUTTON_CreateIndirect, "BT_Set_RecIndex", ID_BUTTON_31, 180, 40, 100, 50, 0, 0x0, 0},
        {BUTTON_CreateIndirect, "BT_FullClearMem", ID_BUTTON_32, 180, 110, 100, 50, 0, 0x0, 0},
        {BUTTON_CreateIndirect, "BT_JumpToDFU", ID_BUTTON_33, 180, 180, 100, 50, 0, 0x0, 0},
        {BUTTON_CreateIndirect, "�o ADC", ID_BUTTON_34, 180, 250, 100, 50, 0, 0x0, 0},
};
...
*       _cbDialog_Page2
*/
static void _cbDialog_Page3(WM_MESSAGE *pMsg)
{
    WM_HWIN hItem;
    int NCode;
    int Id;
    ...
    case WM_INIT_DIALOG:
        //
        // Initialization of 'ED_RecIndex'
        //
        hItem = WM_GetDialogItem(pMsg->hWin, ID_EDIT_43);
        EDIT_SetFont(hItem, &GUI_FontArial21);
        EDIT_SetTextAlign(hItem, TEXT_CF_HCENTER | TEXT_CF_VCENTER);
        ...
        BUTTON_SetText(hItem, Txt_BT_SetRecordIndex);

        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_32);
        BUTTON_SetFont(hItem, &GUI_FontArial18);
        BUTTON_SetText(hItem, Txt_BT_FullClearMem);

        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_33);
        BUTTON_SetFont(hItem, &GUI_FontArial18);
        BUTTON_SetText(hItem, Txt_BT_DFU);

        hItem = WM_GetDialogItem(pMsg->hWin, ID_BUTTON_34);
        BUTTON_SetFont(hItem, &GUI_FontArial18);
        BUTTON_SetText(hItem, Txt_BT_ADC);
    ...
    case WM_NOTIFY_PARENT:
        ...
        // ================================================================================
        case ID_EDIT_31: // Notifications sent by 'ID_EDIT_31'
            switch (NCode)
            {
            case WM_NOTIFICATION_CLICKED:
                break;
            case WM_NOTIFICATION_RELEASED:
                ID_EDIT_FOCUS = Id;
                strcpy((char *)xSystem.Keypad.Header, Txt_NhapIndexRecord);
                xSystem.Keypad.WD_Req = WD_MTAB_SETUP;
                xSystem.Keypad.Type_Req = KP_REQ_VALUE;
                hItem = WM_GetDialogItem(pMsg->hWin, Id);
                xSystem.Keypad.StrLen = KPI_CONTENTSIZE;
                EDIT_GetText(hItem, (char *)xSystem.Keypad.Str, KPI_CONTENTSIZE);
                xSystem.Keypad.StrLen = strlen((const char *)xSystem.Keypad.Str);
                xSystem.Keypad.Index = xSystem.Keypad.StrLen - 1;
                GUI_WD_Change(WD_KEY_NUM);
...
static void _cbDialog(WM_MESSAGE *pMsg)
{
    ...
    case WM_INIT_DIALOG:
        ...
        IMAGE_SetBitmap(hItem, &bmIconBack);
        ...
        MULTIPAGE_SetTabWidth(hMultiPage, 100, 0);

        hDialog = GUI_CreateDialogBox(_aDialogCreate_Page2, GUI_COUNTOF(_aDialogCreate_Page2), _cbDialog_Page2, WM_UNATTACHED, 0, 0);
        MULTIPAGE_AddPage(hMultiPage, hDialog, Txt_HieuChinh);
        MULTIPAGE_SetTabWidth(hMultiPage, 100, 1);

        hDialog = GUI_CreateDialogBox(_aDialogCreate_Page3, GUI_COUNTOF(_aDialogCreate_Page3), _cbDialog_Page3, WM_UNATTACHED, 0, 0);
