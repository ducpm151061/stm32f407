...
const u8 send_test[]="STM32F407VxT6 SPI TEST";   //写入数组
...
void SPI_W25Q64_test(void)
{
	...
	Gui_StrCenter(0,45,RED,BLUE,"SPI 测试程序",16,1);//居中显示	
	...
	Gui_StrCenter(0,165,BLUE,BLUE,"2020-06-05",16,1);//居中显示
	Gui_StrCenter(0,190,GREEN,BLUE,"http://www.lcdwiki.com",16,1);//居中显示
}
...
void Show_W25Q64_Write(void)
{
	...
	Show_Str(lcddev.width/2-84,120,RED,WHITE,"W25Q64 Write Finished!",16,0);//提示传送完成
}
...
void Show_W25Q64_Read(void)
{
	...
	Show_Str(lcddev.width/2-84,140,BLUE,WHITE,rece_buf,16,0);//显示读到的字符串
}
