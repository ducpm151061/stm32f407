...
void IIC_24C02_test(void)
{
	...
	Gui_StrCenter(0, 90, BLUE, BLUE, "KEY_UP:Write  KEY0:Read", 16, 1); //������ʾ
	while (AT24C02_Check())
	{
		Gui_StrCenter(0, 115, RED, WHITE, "24C02 Check Failed!", 16, 0);
		delay_ms(500);
		Gui_StrCenter(0, 115, RED, WHITE, "Please Check!      ", 16, 0);
		delay_ms(500);
		LED0 = !LED0; //LED0��˸
	}
...
/*****************************************************************************
 * @name       :void Show_24C02_Write(void)
 * @date       :2018-08-09 
 * @function   :show 24c02 write
 * @parameters :None
 * @retvalue   :None
******************************************************************************/
...
/*****************************************************************************
 * @name       :void Show_24C02_Read(void)
 * @date       :2018-08-09 
 * @function   :show 24c02 read
 * @parameters :None
 * @retvalue   :None
******************************************************************************/
void Show_24C02_Read(void)
{
	u8 rece_buf[sizeof(send_test)];
	Show_Str(lcddev.width / 2 - 84, 140, RED, WHITE, "Start Read 24C02.... ", 16, 0);
	AT24C02_Read(0, rece_buf, sizeof(send_test));
	Show_Str(lcddev.width / 2 - 84, 140, RED, WHITE, "The Data Readed Is:  ", 16, 0);
	Show_Str(lcddev.width / 2 - 84, 160, BLUE, WHITE, rece_buf, 16, 0); //��ʾ�������ַ���
}
